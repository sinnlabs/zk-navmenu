 ...
 *
 */
org.sinnlabs.ui.zk.navmenu.Sidemenu = zk.$extends(zul.Widget, {
	_logo:'', //default value for logo attribute
	...
	$define: {
		 ...
		 *
		 */
		logo: function() { //this function will be called after setText() .
		
			if(this.desktop) {
				var n = this.$n(uuid + '-brand')
				if (n) {
					n.innerHTML = _logo;
				}
			}
	...
	*/
	bind_: function () {
		 ...
		 */
		this.$supers(org.sinnlabs.ui.zk.navmenu.Sidemenu,'bind_', arguments);
	...
	*/
	unbind_: function () {
		...
		*/
		this.$supers(org.sinnlabs.ui.zk.navmenu.Sidemenu,'unbind_', arguments);
	},
	/*
