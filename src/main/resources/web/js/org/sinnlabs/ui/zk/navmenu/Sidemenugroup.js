 ...
 *
 */
org.sinnlabs.ui.zk.navmenu.Sidemenugroup = zk.$extends(zul.Widget, {
	...
	*/
	...
	getZclass:function() {return this._zclass; },
	setZclass:function(val) {
		this._zclass = val;
	},
	...
	bind_: function () {
		 ...
		 */
		this.$supers(org.sinnlabs.ui.zk.navmenu.Sidemenugroup,'bind_', arguments);
	...
	*/
	unbind_: function () {
		...
		*/
		this.$supers(org.sinnlabs.ui.zk.navmenu.Sidemenugroup,'unbind_', arguments);
	},
	/*
